...
(defun prolog-assert-dialog-element (json-string) 
  "Query prolog with 'assertDialogElement' to update guest info."
  (json-prolog:prolog-simple (format nil "assertDialogElement(~a)"
                        json-string) :lispify T :package :common))
